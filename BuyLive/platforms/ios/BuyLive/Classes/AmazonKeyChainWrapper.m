...
+(NSString *)getValueFromKeyChain:(NSString *)key
{
   ...
   // OSStatus     keychainError       = SecItemCopyMatching((CFDictionaryRef)queryDictionary, (CFTypeRef *)&returnedDictionary);
    NSDictionary *returnedDictionary = [[NSMutableDictionary alloc] init];
    CFTypeRef inTypeRef = (__bridge CFTypeRef)returnedDictionary;
    OSStatus keychainError = SecItemCopyMatching(      (__bridge CFDictionaryRef)queryDictionary, &inTypeRef);
